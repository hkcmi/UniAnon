...
1. Add first-week review item for IdP claim minimization.
2. Implement OIDC callback browser handoff page.
3. Add OIDC callback browser handoff tests.
4. Add OIDC-only launch checklist command coverage.
