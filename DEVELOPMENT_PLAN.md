...
1. Add aggregate metrics documentation examples.
2. Add bootstrap command documentation for Docker deployments.
3. Add governance case detail link in the local UI.
4. Add CI bootstrap command dry-run step.
