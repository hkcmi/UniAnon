...
1. Add readiness summary note for OIDC-only mode.
2. Add OIDC handoff CSP-compatible no-inline-script option.
3. Add OIDC handoff manual fallback link.
4. Add OIDC callback failure-page docs.
