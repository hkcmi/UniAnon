...
1. Add bootstrap command documentation for Docker deployments.
2. Add governance case detail link in the local UI.
3. Add CI bootstrap command dry-run step.
4. Add aggregate metrics UI suppressed-count hint.
