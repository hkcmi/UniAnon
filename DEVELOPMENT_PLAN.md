...
1. Add OIDC state replay test coverage.
2. Add Redis readiness deployment checklist item.
3. Add reverse-proxy no-cache header example.
4. Add automated fake-OIDC browser smoke test.
